// Pure helpers for the WORLD BRIEF pipeline. Ported verbatim from
// worldmonitor.app's scripts/_insights-brief.mjs (commit 902cd7a16,
// AGPL-3.0) — only this import block changed to match this fork's file
// layout (server/worldmonitor/intelligence/v1/_clustering.js and
// server/_shared/*, vs upstream's scripts/_clustering.mjs and
// scripts/shared/*).

import { isBriefLeadEligible } from './_clustering.js';
import { countPublisherFamilies } from '../../../_shared/publisher-families.js';
import {
  validateNoHallucinatedProperNouns,
  validateNoHallucinatedFacts,
  checkLeadGrounding,
  verifyCitationIndexes,
} from '../../../_shared/brief-llm-core.js';
