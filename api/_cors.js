const ALLOWED_ORIGIN_PATTERNS = [
  ...
  // Kept in sync with server/cors.ts. The iOS client sends its baseURL as
  // Origin, so this list is what stops the gateway 403'ing it — auth itself
  // is a separate concern (see api/_api-key.js, which no longer trusts any
  // origin without a key).
