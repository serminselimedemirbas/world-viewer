...
Real-time equity quotes, commodity prices (including SGE physical-vs-COMEX gold and silver premiums), crypto prices, forex FX rates, sector performance and valuation coverage, ETF flows, and Gulf market quotes from WorldMonitor's curated bootstrap cache.
...
- **Freshness budget:** market and sector snapshots allow **30 min**; the daily physical-premium snapshot allows **72 hours** so one missed publish cycle or a market closure does not create a false stale alarm.
